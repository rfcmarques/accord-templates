...
# Accord Protocol Template: simpleslarenewalexample
...
```
cicero parse --template ./simpleslarenewalexample/ --dsl ./simpleslarenewalexample/sample.txt
...
data.json:
{
   "$class": "org.digitalsign.simpleslarenewalexample.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./simpleslarenewalexample/ --dsl ./simpleslarenewalexample/sample.txt --data ./simpleslarenewalexample/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.digitalsign.simpleslarenewalexample.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.digitalsign.simpleslarenewalexample.Response",
